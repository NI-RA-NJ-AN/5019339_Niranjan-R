...
class LibraryManagementSystem {
    ...
    public static void main(String[] args) {
        Book[] books = {
            new Book("1", "The Great Alexander", "F. Scott Fitzgerald"),
            new Book("2", "the hunt", "George Orwell"),
            new Book("3", "To legacy", "Harper Lee"),
            new Book("4", "Pride of nation", "Jane Austen"),
            new Book("5", "The Catcher to man", "J.D. Salinger")
        };
