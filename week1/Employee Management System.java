...
class EmployeeManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        // Adding employees
        ems.addEmployee(new Employee("1", "John ", "Manager", 80000));
        ems.addEmployee(new Employee("2", "Smith", "Developer", 70000));
        ems.addEmployee(new Employee("3", "Mike ", "Analyst", 60000));
